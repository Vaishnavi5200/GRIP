      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    >
                      {reg.status === "operational" ? "Operational" : "Research Mode"}
                    </span>
                  </div>
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-xl p-6 shadow-2xs">
          <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-100">
            ...
            >
              {selectedState.status === "operational" ? "Live Engine" : "Research Mode (No Calc)"}
            </span>
          </div>
            ...
            {selectedState.status === "operational" && (
              <div className="mt-4 pt-4 border-t border-slate-100">
                <h3 className="font-bold text-slate-900 text-xs mb-2">
                  Active Executable Rule Versions (5 Versions)
                </h3>
                <div className="space-y-1.5">
                  {demoStore.ruleVersions.map((rv) => (
                    <div
                      key={rv.id}
                ...
                <div className="mt-4 flex justify-end">
                  ...
                  >
                    View Rule Version Lifecycle & Legal Provenance →
                  </Link>
                </div>
              </div>
            )}
